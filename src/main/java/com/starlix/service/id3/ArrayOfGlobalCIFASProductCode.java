...
public class ArrayOfGlobalCIFASProductCode {

    @XmlElement(name = "GlobalCIFASProductCode", nillable = true)
    protected List<GlobalCIFASProductCode> globalCIFASProductCode;
     ...
     * {@link GlobalCIFASProductCode }
     * 
     * 
     */
    public List<GlobalCIFASProductCode> getGlobalCIFASProductCode() {
        if (globalCIFASProductCode == null) {
            globalCIFASProductCode = new ArrayList<GlobalCIFASProductCode>();
        }
