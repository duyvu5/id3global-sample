...
/**
 * <p>Java class for GlobalItemCheckInputField complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="GlobalItemCheckInputField"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "GlobalItemCheckInputField", propOrder = {
    "category",
    "subCategory",
    "name",
    "regex",
...
public class GlobalItemCheckInputField {

    @XmlElementRef(name = "Category", namespace = "http://www.id3global.com/ID3gWS/2013/04", type = JAXBElement.class, required = false)
    protected JAXBElement<String> category;
    @XmlElementRef(name = "SubCategory", namespace = "http://www.id3global.com/ID3gWS/2013/04", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "Regex", namespace = "http://www.id3global.com/ID3gWS/2013/04", type = JAXBElement.class, required = false)
