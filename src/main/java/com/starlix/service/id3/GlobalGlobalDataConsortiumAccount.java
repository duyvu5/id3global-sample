...
/**
 * <p>Java class for GlobalGlobalDataConsortiumAccount complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="GlobalGlobalDataConsortiumAccount"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "GlobalGlobalDataConsortiumAccount", propOrder = {
    "tenant",
    "username",
    "password"
})
public class GlobalGlobalDataConsortiumAccount
    extends GlobalSupplierAccount
{

    @XmlElementRef(name = "Tenant", namespace = "http://www.id3global.com/ID3gWS/2013/04", type = JAXBElement.class, required = false)
