    ...
    extends GlobalSupplierAccount
{
    ...
    @XmlElementRef(name = "TestMode", namespace = "http://www.id3global.com/ID3gWS/2013/04", type = JAXBElement.class, required = false)
    protected JAXBElement<String> testMode;
     ...
     *     
     */
    public JAXBElement<String> getTestMode() {
        return testMode;
    }
     ...
     *     
     */
    public void setTestMode(JAXBElement<String> value) {
        this.testMode = value;
    }
